...
const SANTANDER_DIR = path.resolve(__dirname, '..', '..', 'EXTRATO NOVEMBRO', 'SANTANDER');
...
// Heurística inicial para Santander:
// Padrão comum: "Data | Histórico | Documento | Valor | Saldo"
...
export async function processSantanderExtracts() {
  const pdfFiles = listPdfFiles(SANTANDER_DIR);
  const results = [];
