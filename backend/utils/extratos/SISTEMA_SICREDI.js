/**
 * Parser para arquivo CSV exportado do SISTEMA (SICREDI)
 ...
 *
 * Exemplo (portador 748 = SICREDI):
 * 44748;COLLYER & SOARES LTDA;57.220.226.0001/15;100;390.048;1;Fatura;748;24/10/2024;23/11/2024;23/11/2024;25/11/2024;30.168,98
 */
...
/**
 * Parseia arquivo CSV do Sistema SICREDI
 * @param {string} csvContent - Conteúdo do arquivo CSV
 * @returns {Object} - { registros }
 */
const parseSistemaSicrediCSV = (csvContent) => {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    // O CSV tem: código;nome;cpf;empresa;fatura;parcela;doc;portador;emissao;vencOrig;vencimento;liquidacao;valor
...
const processSistemaSicrediFile = (fileContent) => {
  try {
    ...
    const { registros } = parseSistemaSicrediCSV(content);
...
export { parseSistemaSicrediCSV, processSistemaSicrediFile };

export default processSistemaSicrediFile;
