...
const SICREDI_DIR = path.resolve(__dirname, '..', '..', 'EXTRATO NOVEMBRO', 'SICREDI');
...
// Heurística inicial para Sicredi:
// Muitos extratos seguem padrão similar: "Data | Histórico | Documento | Valor | Saldo"
...
export async function processSicrediExtracts() {
  const pdfFiles = listPdfFiles(SICREDI_DIR);
  const results = [];
