import { processItauExtracts } from '../utils/extratos/itauExtractor.js';

(async () => {
  try {
    const results = await processItauExtracts();
    console.log('Resumo dos PDFs ITAÚ processados:');
    ...
    console.error('Falha ao executar o parser do ITAÚ:', e);
    process.exit(1);
  }
})();
