import { processSicrediExtracts } from '../utils/extratos/sicrediExtractor.js';

(async () => {
  try {
    const results = await processSicrediExtracts();
    console.log('Resumo dos PDFs SICREDI processados:');
    ...
    console.error('Falha ao executar o parser do SICREDI:', e);
    process.exit(1);
  }
})();
