import { processBNBExtracts } from '../utils/extratos/bnbExtractor.js';

(async () => {
  try {
    const results = await processBNBExtracts();
    console.log('Resumo dos PDFs BNB processados:');
    ...
    console.error('Falha ao executar o parser do BNB:', e);
    process.exit(1);
  }
})();
