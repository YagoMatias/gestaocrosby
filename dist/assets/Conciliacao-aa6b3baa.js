import{r as s,j as t,d as B,G as H,e as V}from"./index-0c0edc1b.js";import{c as d,D as G}from"./contas-51a85483.js";import{m as R}from"./ArrowsClockwise.es-b5a2ad1f.js";import{s as W}from"./CaretUp.es-84744504.js";import{c as $}from"./CaretUpDown.es-fc18bd9a.js";import{p as A}from"./Spinner.es-aa8103cf.js";import{C as Z,a as q,b as J,c as K}from"./cards-d1d8265c.js";import{u as Q}from"./useApiClient-2d5ad2a7.js";const u=20,xe=()=>{const p=Q(),[c,b]=s.useState([]),[X,h]=s.useState(0),[m,g]=s.useState(!1),[v,w]=s.useState(""),[Y,z]=s.useState(!1),[F,y]=s.useState([]),[P,_]=s.useState(0),[ee,j]=s.useState(!1),[te,S]=s.useState("");s.useState(!0);const[l,N]=s.useState({nr_ctapes:[],dt_movim_ini:"",dt_movim_fim:""});s.useState(!0),s.useState(!1),s.useState({title:"",description:"",calculation:""});const[C,D]=s.useState(1),[ae,L]=s.useState(1),[i,I]=s.useState({campo:null,direcao:"asc"}),[se,E]=s.useState(new Set);s.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
      .table-container {
        overflow-x: auto;
        position: relative;
        max-width: 100%;
