import{r as i,j as s,O as Q,x as U}from"./index-0c0edc1b.js";const W=i.memo(i.forwardRef(({type:t="text",label:f,placeholder:$,value:a,onChange:N,onBlur:l,onFocus:d,disabled:c=!1,required:b=!1,error:e,helperText:x,leftIcon:m,rightIcon:u,size:v="md",fullWidth:I=!1,className:C="",containerClassName:S="",id:k,name:h,autoComplete:z,maxLength:r,minLength:P,pattern:E,...M},O)=>{const[o,R]=i.useState(!1),[F,g]=i.useState(!1),n=k||`input-${h||Math.random().toString(36).substr(2,9)}`,y=e?`${n}-error`:void 0,j=x?`${n}-helper`:void 0,w={sm:"px-3 py-1.5 text-sm",md:"px-3 py-2 text-sm",lg:"px-4 py-3 text-base"},V=`
    block w-full rounded-lg border transition-all duration-200
    focus:outline-none focus:ring-2 focus:ring-offset-0
    disabled:opacity-50 disabled:cursor-not-allowed
    ${w[v]||w.md}
    ${e?"border-red-300 focus:border-red-500 focus:ring-red-500":F?"border-[#000638] focus:border-[#000638] focus:ring-[#000638]":"border-gray-300 focus:border-[#000638] focus:ring-[#000638]"}
