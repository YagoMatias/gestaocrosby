import{r as i,j as s,T as Q,x as T}from"./index-864059c8.js";const U=i.memo(i.forwardRef(({type:t="text",label:f,placeholder:$,value:a,onChange:N,onBlur:l,onFocus:d,disabled:c=!1,required:b=!1,error:e,helperText:x,leftIcon:m,rightIcon:u,size:v="md",fullWidth:I=!1,className:C="",containerClassName:S="",id:k,name:h,autoComplete:z,maxLength:r,minLength:P,pattern:E,...M},R)=>{const[o,F]=i.useState(!1),[O,g]=i.useState(!1),n=k||`input-${h||Math.random().toString(36).substr(2,9)}`,y=e?`${n}-error`:void 0,j=x?`${n}-helper`:void 0,w={sm:"px-3 py-1.5 text-sm",md:"px-3 py-2 text-sm",lg:"px-4 py-3 text-base"},V=`
