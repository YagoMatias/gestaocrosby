          ...
          <div className="w-full max-w-6xl mx-auto flex flex-col items-stretch justify-start py-8">
            ...
            <div className="mb-8">
              <form onSubmit={handleFiltrar} className="flex flex-col items-center bg-white p-4 rounded-lg shadow">
                ...
                <div className="flex flex-row w-full justify-center gap-2 flex-wrap mt-2">
                  <div className="flex flex-col">
                    <label className="block text-sm font-medium mb-1">Data Transação Inicial</label>
                    <input
                      type="date"
                      name="dt_inicio"
                  ...
                  <div className="flex flex-col">
                    <label className="block text-sm font-medium mb-1">Data Transação Final</label>
                    <input
                      type="date"
                      name="dt_fim"
                ...
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="bg-gray-100 text-gray-700">
                      ...
                      <th className="px-4 py-2">Nº Transação</th>
                    ...
                    {loading ? (
                      ...
                      dados.map((row, i) => (
                        <tr key={i} className="border-b hover:bg-gray-50">
                          ...
                          <td className="px-4 py-2 text-center">{row.nr_transacao}</td>
