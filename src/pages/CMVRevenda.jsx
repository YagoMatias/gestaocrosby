...
const CMVRevenda = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4">
      <PageTitle
        title="CMV Revenda"
        subtitle="Consulta do CMV do canal Revenda"
        icon={ChartLineUp}
      ...
      <Card className="shadow-lg rounded-xl bg-white mb-6">
        ...
        <CardContent className="pt-0 px-4 pb-4">
          <CardDescription className="text-xs text-gray-500 mb-4">
            Configure os filtros para consulta do CMV Revenda
      ...
      <Card className="shadow-lg transition-all duration-200 hover:shadow-xl hover:-translate-y-1 rounded-xl bg-white">
        ...
        <CardContent className="pt-0 px-4 pb-4">
          <CardDescription className="text-xs text-gray-500 mb-4">
            Detalhes de todos os registros de CMV Revenda
          </CardDescription>
