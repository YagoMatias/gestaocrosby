...
const CreditosClientes = () => {
  ...
  const executarBusca = async () => {
    ...
    try {
      ...
      if (lista.length === 0) {
        setErro('Nenhum cliente encontrado para o termo pesquisado.');
      }
    } catch {
          ...
          <div className="p-4 border-b border-gray-100">
            <div className="relative">
              ...
              <button
                ...
                disabled={searchLoading || !busca.trim()}
                className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#000638] transition-colors disabled:opacity-40"
              >
                {searchLoading ? (
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {cliente.name &&
                          ...
                          cliente.name !== cliente.fantasyName && (
                            <p
                              className={`text-xs truncate mt-0.5 ${selecionado ? 'text-gray-300' : 'text-gray-500'}`}
                            >
                              {cliente.name}
                            </p>
                          )}
