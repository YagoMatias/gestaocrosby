...
const useApiClient = () => {
  ...
  const totvs = {
    ...
    /**
     * Faturamento total do painel de vendas (sale-panel/v2/totals/search)
     * @param {Object} body - { filtroempresa?: number[], datemin: string, datemax: string, operations?: number[], sellers?: number[] }
     */
